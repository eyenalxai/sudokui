...
const convertTdokuFormat = (puzzle: string): string => {
  return puzzle.replaceAll(/\./g, "0")
}

describe("SudokuGrid", () => {
  describe("tdoku puzzle #1", () => {
    const tdokuPuzzle = ".5..83.17...1..4..3.4..56.8....3...9.9.8245....6....7...9....5...729..861.36.72.4"
    const expectedSolution = "652483917978162435314975628825736149791824563436519872269348751547291386183657294"
  ...
  describe("tdoku puzzle #2", () => {
    const tdokuPuzzle = "2.6.3......1.65.7..471.8.5.5......29..8.194.6...42...1....428..6.93....5.7.....13"
    const expectedSolution = "256734198891265374347198652514683729728519436963427581135942867689371245472856913"
  ...
  describe("tdoku puzzle with 125 solutions", () => {
    ...
    const tdokuPuzzle = "8.........95.......67..........2.485...4.3192......736...651947...732518...894263"
